...
function Populate_sysconfig()
{
  ...
  $valueArray[$variable] = array("'$variable'", "'* * * * *'", "'$FossDashScriptCronSchedulePromt'",
    strval(CONFIG_TYPE_TEXT), "'FossDashAPI'", "3", "'$FossDashScriptCronScheduleDesc'", "'$cronIntervalCheck'", "null");

  $variable = "FossologyInstanceUUID";
  $fossologyInstanceUUIDPrompt = _('Fosslogy instance UUID');
  $instanceUUIDValid = "check_fossology_instance_UUID";
  $fossologyInstanceUUIDDesc = _('e.g. Instance UUID formate = [a-zA-Z0-9_-]+ <br>Set the fossology instance UUID. Used autogenerated value if empty.');
  $valueArray[$variable] = array("'$variable'", "null", "'$fossologyInstanceUUIDPrompt'",
    strval(CONFIG_TYPE_TEXT), "'FossDashAPI'", "3", "'$fossologyInstanceUUIDDesc'", "'$instanceUUIDValid'", "null");
  ...
  $FossdashReportingCleaningDesc = _('Set (in days)  older fossdash reported files should cleanup. Disable cleanup if empty.');
  $valueArray[$variable] = array("'$variable'", "null", "'$FossdashReportingCleaningPrompt'",
    strval(CONFIG_TYPE_TEXT), "'FossDashAPI'", "5", "'$FossdashReportingCleaningDesc'", "'$FossdashReportingCleaningValid'", "null");
