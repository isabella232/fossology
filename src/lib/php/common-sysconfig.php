...
function Populate_sysconfig()
{
  ...
  $fossologyInstanceUUIDDesc = _('Set the fossology instance UUID. default autogenerated value if empty.');
  $valueArray[$variable] = array("'$variable'", "null", "'$fossologyInstanceUUIDPrompt'",
    strval(CONFIG_TYPE_TEXT), "'FossologyUUID'", "1", "'$fossologyInstanceUUIDDesc'", "null", "null");
